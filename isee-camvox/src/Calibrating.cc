...
string strSettingPath_ = "/home/computer/camvox_ws/src/CamVox/isee-camvox/camvox/config/camera.yaml";
string RGBPath_ = "/home/computer/camvox_ws/src/CamVox/isee-camvox/camvox/calibration/calibration.bmp";
string PcdPath_ = "/home/computer/camvox_ws/src/CamVox/isee-camvox/camvox/calibration/calibration.pcd";
...
namespace Camvox
{
  ...
  {
    static cv::FileStorage fSettings(filename, cv::FileStorage::READ);
    if (!fSettings.isOpened())
    {
