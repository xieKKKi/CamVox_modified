...
#include "isee_preprocessing/CustomMsg.h"
#include "isee_preprocessing/GPS.h"
...
vector<isee_preprocessing::GPS> rtk_datas;
...
inline double to_time(isee_preprocessing::GPS rtk_data) // sensor_msgs::NavSatFix
{
...
void rtkCbk(const isee_preprocessing::GPS::ConstPtr &msg)
{
